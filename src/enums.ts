...
export enum NodeProp {
  ...
  DISTDB_CUSTOMSCAN = "DistDB CustomScan",
  ...
  TASK_ID = "Task ID",
  WORKER_READ_INTERMEDIATE_RESULTS = "worker_read_intermediate_results",
  SUB_PLANS = "Subplans",
  TOTAL_TIME = "Total Time",
  QUERY_TEXT = "Query Text",
  HOST = "Host",
  TASK_PER_WORKER = "Task Per Worker",
  TASK_DESC_ORDER = "Task Desc Order",
